...
void man(char *name)  //60
{
    ...
    {
        printf("ERROR : No manual entry availale.\n");
    }
}
...
void DisplayHelp() 
{
    ...
    printf("fstst : To Display information of file using file descriptor\n");
